                                    ...
                                    <div class="card-body">
                                        <form action="register" method="post">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputFullname" name="inputFullname" type="text" placeholder="Enter your name" />
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><input class="btn btn-primary btn-block" type="submit" value="Create Account"></a></div>
                                            </div>
                                        </form>
                                    </div>
