 ...
 * @author Acer
 */
@WebServlet(name = "ClassSettingCreateController", urlPatterns = {"/classSettingcreate"})
public class ClassSettingCreateController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       //int id = Integer.parseInt(request.getParameter("id"));
        ...
        request.setAttribute("panel", "ClassSetting_create");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        new AddMilestoneClassSetingDAO().addClassSetting(a);
