                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            <div class="card-header"><h3 class="text-center font-weight-light my-4">Add Class Setting</h3></div>
                            <div class="card-body">
                                <form action="classSettingcreate" method="post">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input class="form-control" id="inputOrder" name="order" type="number" required="" value="${a.display_order}" required pattern="[-+]?[0-9]" min="0" max="1000" title="number 0-1000 only!">
                                        </div>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <p class="text-medium-emphasis">Title<label class="required">(*)</label></p>
                                        <input class="form-control" id="inputName" name="title" type="text" value="" required="" required pattern="[A-Za-z0-9 ]+" minlength="3" maxlength="15">
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <p class="text-medium-emphasis">Value</p><br>
                                            <input class="form-control" id="inputValue" name="value" type="text" required="" value="${a.setting_value}">
                                        </div>
                                        <div class="col-md-6">
